...
export default function Form() {
  ...
  return <>
    ...
    <form className="w-full h-full xl:h-fit bg-white xl:shadow-xl p-4 rounded-lg flex flex-col gap-8 pb-12 md:text-[2.5vh] md:justify-between xl:text-xl" onSubmit={handleFormSubmit}>
      ...
      <div className="relative flex flex-col md:text-lg gap-1 before:absolute before:content-[''] before:w-full before:h-[2px] before:bg-[#CCCCCC] before:-bottom-4"><p className="md:text-xl">Płatność:</p><div className="radio-input"><label className="label bg-[#f28a7270] rounded-xl"><input type="radio" checked readOnly name="value-radio" /><p className="text">Za pobraniem gotówką</p></label></div></div>
